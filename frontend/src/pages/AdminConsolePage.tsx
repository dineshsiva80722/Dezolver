    ...
    <div className="max-w-7xl mx-auto">
      ...
      {activeTab === 'dashboard' && stats && (
        <div className="space-y-6">
          ...
          {/* Admin Quick Actions */}
          <div className="bg-card text-card-foreground rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold mb-4">Admin Modules</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <a
                href="/admin/hr"
                className="group p-4 border border-border rounded-lg hover:bg-muted transition-colors text-center"
              >
                <div className="text-2xl mb-2">👥</div>
                <div className="font-semibold text-foreground group-hover:text-primary">HR Management</div>
                <div className="text-xs text-muted-foreground">Employees & Payroll</div>
              </a>
              <a
              ...
              >
                <div className="text-2xl mb-2">🎓</div>
                <div className="font-semibold text-foreground group-hover:text-primary">Certificates</div>
                <div className="text-xs text-muted-foreground">Templates & Verification</div>
              </a>
              <a
              ...
              >
                <div className="text-2xl mb-2">📝</div>
                <div className="font-semibold text-foreground group-hover:text-primary">Create Problem</div>
                <div className="text-xs text-muted-foreground">Add new problems</div>
              </a>
              <a
              ...
              >
                <div className="text-2xl mb-2">🏆</div>
                <div className="font-semibold text-foreground group-hover:text-primary">Create Contest</div>
                <div className="text-xs text-muted-foreground">Organize contests</div>
              </a>
            </div>
          </div>
          ...
          <div className="bg-card text-card-foreground rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3 p-3 bg-muted rounded">
                ...
                <span className="text-sm">Certificate generated for course completion</span>
                <span className="text-xs text-muted-foreground ml-auto">2 hours ago</span>
              </div>
              <div className="flex items-center space-x-3 p-3 bg-muted rounded">
                <span className="text-indigo-600">💰</span>
                <span className="text-sm">Monthly payroll processed for 15 employees</span>
          ...
          <div className="bg-card text-card-foreground rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-3 bg-muted rounded">
                ...
                <div className="text-sm text-muted-foreground">{config.app.name} v{config.app.version}</div>
              </div>
              <div className="p-3 bg-muted rounded">
